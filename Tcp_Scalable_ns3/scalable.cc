...
main (int argc, char *argv[])
{
  ...
  std::string firstTcpRttTraceFile = "scalable-scenarios-first-tcp-rtt.dat";
  std::string firstTcpCwndTraceFile = "scalable-scenarios-first-tcp-cwnd.dat";
  std::string firstTcpThroughputTraceFile = "scalable-scenarios-first-tcp-throughput.dat";
  std::string secondTcpRttTraceFile = "scalable-scenarios-second-tcp-rtt.dat";
  std::string secondTcpCwndTraceFile = "scalable-scenarios-second-tcp-cwnd.dat";
  std::string secondTcpThroughputTraceFile = "scalable-scenarios-second-tcp-throughput.dat";
  std::string routerDropTraceFile = "scalable-scenarios-router-drops.dat";
  std::string routerDropsFrequencyTraceFile = "scalable-scenarios-router-drops-frequency.dat";
  std::string routerLengthTraceFile = "scalable-scenarios-router-length.dat";

  float bottleneck = 500;
  float rtt_h1_h3 = 12;
  float rtt_h2_h3 = 12;
  ...
  std::string firstTcpType = "scalable";
  std::string secondTcpType = "scalable";
  ...
  TypeId firstTcpTypeId = TcpScalable::GetTypeId ();
  ...
  p2p.SetDeviceAttribute ("DataRate", DataRateValue (DataRate ("500Mbps")));
  ...
  tchFq2.SetQueueLimits ("ns3::DynamicQueueLimits", "HoldTime", StringValue ("1ms"));  
  ...
  if (enablePcap)
    {
      p2p.EnablePcapAll ("scalable-scenarios", false);
    }
