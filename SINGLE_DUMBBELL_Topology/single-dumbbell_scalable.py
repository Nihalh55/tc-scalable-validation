...
flow1 = Flow(n1, n2, n2_r2.get_address(), 0, 60, 4)
flow2 = Flow(n2, n1, n1_r1.get_address(), 0, 60, 4)

# First experiment
exp1 = Experiment("tcp_4up")
exp1.add_tcp_flow(flow1,"scalable")
exp1.require_qdisc_stats(r1_r2)
exp1.require_qdisc_stats(r2_r1)

# Second experiment
exp2 = Experiment("tcp_4down")
exp2.add_tcp_flow(flow2,"scalable")
exp2.require_qdisc_stats(r2_r1)

# Third experiment
exp3 = Experiment("tcp_4up&down")
exp3.add_tcp_flow(flow1,"scalable")
exp3.add_tcp_flow(flow2,"scalable")
